...
const initialize = function (collectionObject) {
    adminAnalyticsCollection = collectionObject;
}
 ...
 */
const addAdminAnalytics = function (analyticsObj, callback) {
    adminAnalyticsCollection.insert(analyticsObj, function (err, obj) {
        if (err) {
...
const getLimitedAdminAnalyticsListSorted = function (searchQuery, sortQuery, lim, callback) {
    adminAnalyticsCollection.find(searchQuery).sort(sortQuery).limit(lim).toArray(function (err, list) {
        if (err) {
            console.log(err);
...
// <exports> -----------------------------------
exports.addAdminAnalytics = addAdminAnalytics;
exports.getLimitedAdminAnalyticsListSorted = getLimitedAdminAnalyticsListSorted;
